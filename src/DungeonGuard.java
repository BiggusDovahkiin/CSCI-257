...
public class DungeonGuard extends NPC{
	...
	public void talk() {
		if (convo == -1) {
			...
			String[] options = { "How does one Acheve the Rank of Banneret?", 
					"But you yourself arent a Banneret? Shall I have you Reported to the King Himself?", 
					"HOW DARE YOU PEASANT. ILL HAVE YOU KNOW THAT I AM HELD SECOND TO ONLY HIS MAJESTY HIMSELF. IF YOU DO NOT DISPATCH YOUSELF IMMEDIATELY I WILL HAVE YOU BURNED IN THE CONFINES OF THE DUNGEONS." };
			getResponse(options);
		}
